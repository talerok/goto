...
- **Context menu** — Open, Open With, Reveal in Finder, Copy Path, Move to Trash, Get Info
...
SwiftUI with `@Observable` state management. AppKit bridges for the address bar text field (NSTextField via NSViewRepresentable) and Quick Look (QLPreviewPanel).
...
Sources/
  ...
  Views/
    ...
    FileList/                Table with sortable columns
